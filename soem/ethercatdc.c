...
boolean ecx_configdc(ecx_contextt *context)
{
   ...
   for (i = 1; i <= *(context->slavecount); i++)
   {
      ...
      if (context->slavelist[i].hasdc)
      {
         ...
         /* finding DC parent of act_current */
         parent = i;
         do
         {
            child = parent;
         ...
         if (parent > 0)
         {
            ...
            /* act_current slave has children */
            ...
            if (dt1 > dt3) dt1 = -dt1;
            /* act_current slave is not the first child of parent */
            ...
            /* calculate act_current slave delay from delta times */
      ...
      else
      {
         ...
         /* if non DC slave found on first act_position on branch hold root parent */
